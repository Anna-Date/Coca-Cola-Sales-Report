We analyze sales, profit margins, prices, regions and more. First, we start uploading the dataset from excel using power query. And work on the following visuals:
